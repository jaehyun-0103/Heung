...
class MainAdapter(private val postList: MutableList<Posts>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_mainlist, parent, false)
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.tv_comment).text = post.post_content
