...
public final class ActivityLogcheckBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityLogcheckBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLogcheckBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_logcheck, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLogcheckBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.HeungTextView;
      TextView HeungTextView = ViewBindings.findChildViewById(rootView, id);
      if (HeungTextView == null) {
        break missingId;
      }
