...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textViewHome) {
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.textView_home;
      TextView textViewHome = ViewBindings.findChildViewById(rootView, id);
      if (textViewHome == null) {
        break missingId;
      }

      return new FragmentMainBinding((ConstraintLayout) rootView, textViewHome);
    }
